...
export const metadata: Metadata = {
  ...
  description:
    "Demandez une démonstration gratuite de CertPilot : logiciel SaaS de gestion des formations, habilitations CACES, SST, habilitations électriques. Réponse sous 24h. À partir de 69€/mois.",
  keywords: [
